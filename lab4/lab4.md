...
В ходе выполнения лабораторной работы были получены знания о применении оконных функции с использованием синтаксиса OVER(), PARTITION BY и ORDER BY, использовании функций ранжирования ROW_NUMBER(), RANK(), DENSE_RANK(), а также вычислении скользящих минимумов и максимумов с помощью оконных агрегатных функций.
